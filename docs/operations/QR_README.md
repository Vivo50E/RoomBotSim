...
If the laptop changes networks or uses another port, regenerate it from the `roombotsim/` directory:

```sh
.venv/bin/python tools/generate_qr.py http://YOUR.LAN.IP:8000/
```
